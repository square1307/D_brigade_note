...
がこちらのlv4を消滅させるときなど。  
最初はオメガモンAceメインで見てたがあまりにも見かけない、が、デコイ自体は使い道がかなりあった。  
19弾からもメガログラウモンAceの効果による消滅数を減らせる。（デコイは別効果扱いなのでその分のメモリー+はない）

こちらとBT16の方が環境によって枚数調整する枠と感じてる。 

## lv4: 9枚
戻った…でも9枚はやっぱ苦しいわ…  
問い合わせの返答次第にEX3シールズドラモンも入れてみたい。
...
なりふり構わなくなってるので進化元にSRコマンドラモンがあればアタック！アタック時で出す！セキュリティからなんかあったら出たやつを消滅させて耐える！  
ユーリンいるなら賭けて連携も辞さない！！！ってケースも増えてきた。
...
BT18以降はテイマーやマザーも多くなって、安く出せるデクスモンを連携先にしてブロックされない2チェックとかも。


### EX3 シールズドラモン 1枚

ヌメモンと使うなら紗月の枠もひねり出したかったなのと、紫GSのロストルム、タオルインモードによるDPマイナスがしんどすぎて、ヌメモンよりも攻める速度が高いこちらにしました。

* 進化元でDブリガードが登場したら速攻（手打ちも可）
* ジャミングで序盤中盤でも安全に1点削ってから進化できる
* 序盤でもトラッシュに落ちたパーツをジャミング+ミサイモンの進化元効果で戻せる
...
ついでに軽減+合計7/6でlv7Aceまで取れる。   
対オメガモンAce要員でもある。当のオメガモンAceは見かけないがまぁLv7Aceと思っていただければ。
...
こう使う！って最近増えたのはブリガードラモンがいる場面でトラッシュにあるこいつをDCDボムで戻して一気に虫とかを取るとか。
...
連パンにも使えるが自分はうまく扱えなくてもっぱら除去メインになってる。

進化「するとき」にDブリのデジモンをトラッシュから5枚までデッキトップに戻して、1枚ごとに進化コスト-1なので実質0コスト進化+進化ドロー固定。
これでタンクドラモンを戻して、ターン終了時ブリガードラモンで出すなども。  
この1枚があると除去ルートが広がる。


### BT18 ブラックセラフィモンAce 2枚

BT18で新しく降臨した、黃黒の汎用カード。
...
カオスモン使わなくなったからテイマーレストさせない・進化させないセントガルゴモンAceや横展開を封じるヴァイクモンAceとの選択か？
...
カオスモンは悪くない。デクスモンが便利すぎただけだった。

みんなご存知殴れるオプション。  
BT18はテイマーもしくはマザーブロッカーが多くなって、  
これ投げる！相手消える！とかのケースこそ少なくなったが、  
相手の場面に常にコスト低下要員がいっぱいいて、安く出せるシールズドラモンの連携先としても使える。  
 
あとはスクランブルで拾えるのでこれにした。
クォーツモンと選択。
...
### BT16 警視庁生活安全部サイバー犯罪課捜査第11係デジモン犯罪対策チーム 2枚

減らした。序盤しか打つ機会見つからないので…
